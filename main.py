...
old_price_atom=[0,0]
old_price_avax =[0,0]
old_price_banano=[0,0]
old_price_bch=[0,0]
old_price_bitcoin=[0,0]
old_price_bnb=[0,0]
old_price_cake=[0,0]
old_price_cardano=[0,0]
old_price_chainlink=[0,0]
old_price_cronos=[0,0]
old_price_dogecoin=[0,0]
old_price_eos=[0,0]
old_price_ethereum=[0,0]
old_price_litecoin=[0,0]
old_price_mana=[0,0]
old_price_matic=[0,0]
old_price_monero=[0,0]
old_price_polkadot=[0,0]
old_price_sand=[0,0]
old_price_shiba=[0,0]
old_price_solana=[0,0]
old_price_tezos=[0,0]
old_price_trx=[0,0]
old_price_uniswap=[0,0]
old_price_xlm=[0,0]
old_price_xrp = [0,0]
old_price_nano = [0,0]
old_price_kaspa = [0,0]
...
def fetching_status():
    global _status, change_in_price_algo, change_in_price_ape,change_in_price_atom ,change_in_price_avax ,change_in_price_banano ,change_in_price_bch ,change_in_price_bitcoin ,change_in_price_bnb ,change_in_price_cake ,change_in_price_cardano ,change_in_price_chainlink, change_in_price_cronos ,change_in_price_dogecoin, change_in_price_eos ,change_in_price_ethereum ,change_in_price_litecoin, change_in_price_mana,change_in_price_matic,change_in_price_monero,change_in_price_polkadot, change_in_price_sand , change_in_price_shiba, change_in_price_solana , change_in_price_tezos , change_in_price_trx, change_in_price_uniswap, change_in_price_xlm, change_in_price_xrp,change_in_price_kaspa, change_in_price_bat ,mcap_algo,mcap_ape,mcap_atom,mcap_avax,mcap_banano,mcap_bch,mcap_bitcoin,mcap_bnb,mcap_cake,mcap_cardano,mcap_chainlink,mcap_cronos,mcap_dogecoin,mcap_eos,mcap_ethereum,mcap_litecoin,mcap_mana,mcap_matic,mcap_monero,mcap_polkadot,mcap_sand,mcap_shiba,mcap_solana,mcap_tezos,mcap_trx,mcap_uniswap,mcap_xlm,mcap_xrp,mcap_kaspa, mcap_bat ,dailyvol_algo,dailyvol_ape,dailyvol_atom,dailyvol_avax, dailyvol_banano,dailyvol_bch,dailyvol_bnb, dailyvol_cake, dailyvol_cardano, dailyvol_chainlink, dailyvol_cronos, dailyvol_dogecoin, dailyvol_eos, dailyvol_ethereum, dailyvol_litecoin, dailyvol_mana, dailyvol_matic, dailyvol_monero, dailyvol_polkadot, dailyvol_sand, dailyvol_shiba, dailyvol_solana, dailyvol_tezos, dailyvol_trx, dailyvol_uniswap, dailyvol_xlm, dailyvol_xrp, dailyvol_bat, dailyvol_kaspa,a1_algo, a1_ape, a1_atom, a1_avax , a1_banano, a1_bch, a1_bitcoin, a1_bnb, a1_cake,a1_cardano,a1_chainlink,a1_cronos,a1_dogecoin, a1_eos, a1_ethereum, a1_litecoin, a1_mana, a1_matic, a1_monero, a1_polkadot, a1_sand, a1_shiba, a1_solana, a1_tezos, a1_trx, a1_uniswap, a1_xlm, a1_xrp,a1_kaspa,a1_bat,a2_bat, a3_bat,a2_algo, a2_ape, a2_atom, a2_avax , a2_banano, a2_bch, a2_bitcoin, a2_bnb, a2_cake,a2_cardano,a2_chainlink,a2_cronos,a2_dogecoin, a2_eos, a2_ethereum, a2_litecoin, a2_mana, a2_matic, a2_monero, a2_polkadot, a2_sand, a2_shiba, a2_solana, a2_tezos, a2_trx, a2_uniswap, a2_xlm, a2_xrp ,a2_kaspa,a3_algo, a3_ape, a3_atom, a3_avax , a3_banano, a3_bch, a3_bitcoin, a3_bnb, a3_cake,a3_cardano,a3_chainlink,a3_cronos,a3_dogecoin, a3_eos, a3_ethereum, a3_litecoin, a3_mana, a3_matic, a3_monero, a3_polkadot, a3_sand, a3_shiba, a3_solana, a3_tezos, a3_trx, a3_uniswap, a3_xlm, a3_xrp , a3_kaspa
    global stonks_or_not_algo, stonks_or_not_ape, stonks_or_not_atom, stonks_or_not_avax ,stonks_or_not_banano,stonks_or_not_bch,stonks_or_not_bitcoin,stonks_or_not_bnb,stonks_or_not_cake,stonks_or_not_cardano,stonks_or_not_chainlink,stonks_or_not_cronos,stonks_or_not_dogecoin,stonks_or_not_eos,stonks_or_not_ethereum,stonks_or_not_litecoin,stonks_or_not_mana,stonks_or_not_matic,stonks_or_not_monero,stonks_or_not_polkadot,stonks_or_not_sand,stonks_or_not_shiba,stonks_or_not_solana,stonks_or_not_tezos,stonks_or_not_trx,stonks_or_not_uniswap,stonks_or_not_xlm,stonks_or_not_xrp, stonks_or_not_kaspa, stonks_or_not_bat
    global change_in_price_nano , dailyvol_nano , stonks_or_not_nano, mcap_nano, a1_nano, a2_nano , a3_nano
